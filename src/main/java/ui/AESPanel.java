...
public class AESPanel extends JPanel implements SwingThreadInitListener
{
    ...
    private final String CREATE_ACCOUNT_TABLE = "create table if not exists Account("
            + "id integer PRIMARY KEY AUTOINCREMENT," + "project nvarchar(100)," + "username nvarchar(100),"
            + "password varchar(50)," + "workKey char(64)" + ");";

    private final String QUERY_ACCOUNT = "select * from account;";
    ...
    private void initUI()
    {
        ...
        addBtn.addActionListener(new ActionListener()
        {
            ...
            {
                dataTableModel.addRow(new Account());
            }
        });
